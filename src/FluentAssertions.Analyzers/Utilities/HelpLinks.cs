    ...
    public static class HelpLinks
    {
        ...
        static HelpLinks()
        {
            TypesHelpLinks = new Dictionary<Type, string>
            {
                ...
                [typeof(DictionaryShouldContainKeyAnalyzer.ContainsKeyShouldBeTrue)] = GetHelpLink(""),
                [typeof(DictionaryShouldContainKeyAndValueAnalyzer.ShouldContainKeyAndContainValueSyntaxVisitor)] = GetHelpLink(""),
                [typeof(DictionaryShouldContainKeyAndValueAnalyzer.ShouldContainValueAndContainKeySyntaxVisitor)] = GetHelpLink(""),
                [typeof(DictionaryShouldContainPairAnalyzer.ContainKeyValueSyntaxVisitor)] = GetHelpLink(""),
                [typeof(DictionaryShouldContainPairAnalyzer.ShouldContainKeyAndContainValueSyntaxVisitor)] = GetHelpLink(""),
                [typeof(DictionaryShouldContainPairAnalyzer.ShouldContainValueAndContainKeySyntaxVisitor)] = GetHelpLink(""),
                [typeof(DictionaryShouldContainValueAnalyzer.ContainsValueShouldBeTrue)] = GetHelpLink(""),
                [typeof(DictionaryShouldNotContainKeyAnalyzer.ContainsKeyShouldBeFalseSyntaxVisitor)] = GetHelpLink(""),
                [typeof(DictionaryShouldNotContainValueAnalyzer.ContainsValueShouldBeFalse)] = GetHelpLink(""),
                ...
                [typeof(NumericShouldBeNegativeAnalyzer.NumericShouldBeNegativeSyntaxVisitor)] = GetHelpLink(""),
                [typeof(NumericShouldBePositiveAnalyzer.NumericShouldBePositiveSyntaxVisitor)] = GetHelpLink(""),
